...
COMANDOS = "pkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/Gatomodz11/Lorena-Bot-MD\ncd Lorena-Bot-MD\nyarn install\nnpm install\nnpm start"
...
echo -e "\033[1;35m"
git clone https://github.com/Gatomodz11/Lorena-Bot-MD.git
